...
export class ExpenseQueryDto {
  @ApiPropertyOptional({ description: 'Account ID to filter expenses', example: '507f1f77bcf86cd799439011' })
  @IsOptional()
  @IsString()
  accountId?: string;

  @ApiPropertyOptional({ description: 'Category ID to filter expenses', example: '507f1f77bcf86cd799439012' })
  @IsOptional()
  @IsString()
  categoryId?: string;

  @ApiPropertyOptional({ description: 'User ID to filter expenses', example: '507f1f77bcf86cd799439013' })
  @IsOptional()
  @IsString()
  userId?: string;
  ...
  @ApiPropertyOptional({ description: 'Filter by recurring expenses', example: false })
  @IsOptional()
  @IsBoolean()
  @Transform(({ value }) => value === 'true')
  isRecurring?: boolean;

  @ApiPropertyOptional({ description: 'Filter by shared expenses', example: false })
  @IsOptional()
  @IsBoolean()
  @Transform(({ value }) => value === 'true')
  isSharedExpense?: boolean;

  @ApiPropertyOptional({ description: 'Filter by private expenses', example: false })
  @IsOptional()
  @IsBoolean()
  @Transform(({ value }) => value === 'true')
  isPrivate?: boolean;

  @ApiPropertyOptional({ description: 'Filter by flagged expenses', example: false })
  @IsOptional()
  @IsBoolean()
  @Transform(({ value }) => value === 'true')
  isFlagged?: boolean;

  @ApiPropertyOptional({ description: 'Filter by expenses needing review', example: false })
  @IsOptional()
  @IsBoolean()
  @Transform(({ value }) => value === 'true')
  needsReview?: boolean;

  @ApiPropertyOptional({ description: 'Filter by expense status', enum: ['active', 'pending_approval', 'approved', 'rejected'] })
  @IsOptional()
  @IsString()
