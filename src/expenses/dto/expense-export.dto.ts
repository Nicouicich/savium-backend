...
export class ExpenseExportDto {
  @ApiPropertyOptional({ description: 'Account ID to export expenses from', example: '507f1f77bcf86cd799439011' })
  @IsOptional()
  @IsString()
  accountId?: string;
  ...
  @ApiPropertyOptional({ description: 'Include private expenses', default: true })
  @IsOptional()
  @IsBoolean()
